...
int main ()
{
	...
	for (map<char,int>::reverse_iterator rit = mymap.rbegin() ; rit != mymap.rend() ; ++rit)
	...
	*/
	...
	for (it=map3.begin(); it!=map3.end(); ++it)
		std::cout << it->first << " => " << it->second << '\n';
	for (map<char,int>::reverse_iterator it=map3.rbegin(); it!=map3.rend(); ++it)
		std::cout << it->first << " => " << it->second << '\n';
	...
	for (it=map4.begin(); it!=map4.end(); ++it)
		std::cout << it->first << " => " << it->second << '\n';
	for (map<char,int>::reverse_iterator it=map4.rbegin(); it!=map4.rend() ; ++it)
		std::cout << it->first << " => " << it->second << '\n';
	...
	it = map5.find('b');
	for (map<char,int>::iterator iter=map5.begin(); iter!=map5.end(); ++iter)
	...
	map<char,int>::key_compare mycomp = map6.key_comp();
	...
	pair<char,int> highest2 = *map6.rbegin();          // last element
